...
def input_validation(item):
    ...
    if SourceLanguageCode == TargetLanguageCode:
        ...
        logging.warnng("Neither the SourceLanguageCode and TargetLanguageCode are valid - stopping") 
        return False
    elif SourceLanguageCode not in languages:
        print("The SourceLanguageCode is not valid - stopping")
        logging.warnng("The SourceLanguageCode is not valid - stopping") 
        return False
        ...
        logging.info("The Source Language and Target Language codes are valid - proceeding") 
        return True
    else:
